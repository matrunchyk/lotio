...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "All lotio options are supported and passed through, including:"
            echo "  --debug                        Enable debug output (shows detailed image loading/rendering logs)"
            echo "  --layer-overrides FILE         Path to layer overrides JSON"
            echo ""
            echo "lotio usage:"
