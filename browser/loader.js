...
import { initLotio, createAnimation, renderFrameToCanvas, renderFrameRGBA, cleanup, registerFont } from './lotio_wasm.js';
...
export class Lotio extends EventEmitter {
    ...
    constructor(options = {}) {
        ...
        this._wasmPath = options.wasmPath || './lotio.wasm';
